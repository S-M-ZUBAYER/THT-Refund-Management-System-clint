...
router.post('/order/add', (req, res) => {
  ...
  const {orderNumber,productName,modelNo,image,quantity,price,color,colorImg,customerName, customerPhone,remark,orderDate,orderTime,city,state,country,address,deliveryCharge,orderTrackingNo, warehouseName } = orderDetails;

  const sql = `INSERT INTO orderDetails (orderNumber,productName,modelNo,image,quantity,price,color,colorImg,customerName, customerPhone,remark,orderDate,orderTime,city,state,country,address,deliveryCharge,orderTrackingNo,warehouseName) VALUES (?,?,?, ?, ?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)`;

  connection.query(sql, [orderNumber,productName,modelNo,image,quantity,price,color,colorImg,customerName, customerPhone,remark,orderDate,orderTime,city,state,country,address,deliveryCharge,orderTrackingNo,warehouseName], function (err, result) {
    if (err) {
      console.error(err);
...
router.post('/checkOut/add', (req, res) => {
    const {
      orderNumber,
      orderTime,
      shopName,
